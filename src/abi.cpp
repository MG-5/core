...
extern "C"
{
    ...
    // GCC newer than 10 produces warnings that functions from newlibs are not implemented
    // so we use stubs provided here https://sourceware.org/newlib/libc.html#Stubs
